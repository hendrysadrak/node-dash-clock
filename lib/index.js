...
const themeConfig   = require( `${__dirname}/../themes/${CURRENT_THEME_NAME}/config.js` )( { constants, chalk } );
const themeTypeface = require( `${__dirname}/../themes/${CURRENT_THEME_NAME}/typeface.js` )( { constants } );
